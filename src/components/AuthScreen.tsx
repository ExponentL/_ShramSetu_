...
export const AuthScreen: React.FC = () => {
  ...
  const demoPersonas: Array<{
    ...
    },
    {
      ...
      title: 'Worker Portal',
      badge: 'Artisan',
      description: 'Rajesh Kumar (Electrician, Bahadurgarh Labour Cooperative)',
      user: {
        id: 'w-100',
        name: 'Rajesh Kumar',
        ...
        role: 'worker',
        trade: 'Electrical',
        memberId: 'BLCS-2017-188',
        societyId: 'coop-bahadurgarh-society',
        societyName: 'Bahadurgarh Labour Cooperative Society',
        city: 'Bahadurgarh',
      },
    },
    {
